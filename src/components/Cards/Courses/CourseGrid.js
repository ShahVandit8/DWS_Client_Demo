                ...
                <div className="card-body shadow-hover" style={{ border: 'none' }}>
                    ...
                    <div className='row p-0'>
                        ...
                        <div className='col-6 pr-3'>
                            ...
                            <Link className='float-right' to={"/enrollment/" + id} style={{ fontSize: '15px', textDecoration: 'none', color: 'inherit' }}><i className='bi bi-cart' style={{ fontSize: '17px' }}></i>Enroll Now</Link>
                        </div>
                    </div>
                </div>
            </div>
